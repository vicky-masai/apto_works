    ...
    <Layout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-bold tracking-tight">Money Deposits</h1>
        </div>
        ...
        {isViewDialogOpen && selectedTransaction && (
          ...
          >
            <div 
              className="bg-white rounded-xl shadow-2xl w-[800px] max-h-[90vh] overflow-hidden"
              onClick={e => e.stopPropagation()}
            >
              <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                ...
                <div className="space-y-8">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-3">
                        ...
                        <p className="flex justify-between">
                          ...
                          <span className="font-mono text-sm text-gray-900">{selectedTransaction.upiRefNumber || 'N/A'}</span>
                        </p>
                      </div>
                      <div className="space-y-3">
                        <p className="flex justify-between">
                          <span className="text-gray-600">User Name:</span>
                          <span className="font-medium text-gray-900">{selectedTransaction.user?.name || 'N/A'}</span>
                        </p>
                        <p className="flex justify-between">
                          <span className="text-gray-600">User Email:</span>
                          <span className="text-gray-900">{selectedTransaction.user?.email || 'N/A'}</span>
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-3">
                        <p className="flex justify-between">
                          <span className="text-gray-600">Admin UPI:</span>
                          <span className="font-medium text-gray-900">{selectedTransaction.adminUpi?.upiId || 'N/A'}</span>
                        </p>
                        <p className="flex justify-between">
                          <span className="text-gray-600">Admin UPI Name:</span>
                          <span className="text-gray-900">{selectedTransaction.adminUpi?.name || 'N/A'}</span>
                        </p>
                      </div>
                      <div className="space-y-3">
                        <p className="flex justify-between">
                          <span className="text-gray-600">User UPI:</span>
                          <span className="font-medium text-gray-900">{selectedTransaction.paymentMethod?.upiId || 'N/A'}</span>
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {selectedTransaction.proofImages && selectedTransaction.proofImages.map((proof, index) => (
                  ...
                  {selectedTransaction.status === "Rejected" && (
                    <div className="bg-red-50 p-6 rounded-lg">
                      <h3 className="text-lg font-semibold text-red-900 mb-2">Rejection Details</h3>
                      <p className="text-red-700">{selectedTransaction.rejectReason || 'No reason provided'}</p>
                      <p className="text-sm text-red-600 mt-2">
                        Rejected on: {new Date(selectedTransaction.updatedAt).toLocaleString()}
                      </p>
                    </div>
                  )}
                </div>
